                                            ...
                                            <table class="table table-borderless table-striped table-earning">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $data->subjek }}</td>
                                                        <td>
                                                            <a href="{{ url('/a/contact/detail/' .$data->id) }}">
                                                                <button type="button" class="btn btn-info btn-sm">
                                                                    <i class="fa fa-eye"></i>
                                                                </button>
                                                            </a>
                                                            <a href="javascript:if(confirm('Apakah anda yakin ingin menghapus data ?')) window.location.href = '{{ url('/a/contact/delete/' .$data->id) }}'">
